...
a persistence unit "pruebaPracticaPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/ups/edu/pruebaPractica/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "pruebaPractica/pom.xml":
...
artifact ("pruebaPractica.war") is already built. You can build
